...
const AddFlight = (props) => {
  return (
    <div className="ui form field segment container">
      <h4 class="ui dividing header">Manage Flights</h4>
      ...
      <div className="three fields">
        ...
        <TextInputWithLabel label={"Number of Rows:"} placeholder={"Rows ..."} />
        <TextInputWithLabel label={"Number of Cols:"} placeholder={"Cols ..."} />
      </div>
